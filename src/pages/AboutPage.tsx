...
import { Users, Award, Brain, Target, Globe, Mail, Linkedin, Github, CheckCircle, Zap } from 'lucide-react';
  ...
  const coreActivities = [
    {
      ...
      description: "Conducting cutting-edge research in neural networks, evolutionary computation, and fuzzy systems.",
      icon: <Brain className="h-8 w-8" />
    },
    {
      title: "Educational Workshops",
      description: "Regular workshops on AI, machine learning, and computational intelligence techniques.",
      icon: <Users className="h-8 w-8" />
    },
    {
      title: "Industry Collaboration",
      description: "Partnerships with leading tech companies for internships and real-world projects.",
      icon: <Globe className="h-8 w-8" />
    },
    {
      title: "Conference Organization",
      description: "Hosting international conferences and symposiums on computational intelligence.",
  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-cream/90 leading-relaxed max-w-3xl mx-auto">
              A dynamic community of students passionate about artificial intelligence, machine learning, and intelligent systems.
            </p>
          </div>
        </div>
      </section>
            ...
            <Card className="glass border-accent/20 glow-purple hover-glow transition-all duration-500 animate-slide-in-left">
              <CardHeader>
                <CardTitle className="flex items-center gap-4 text-2xl">
                  ...
                  <span className="text-glow-cream">Our Mission</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  To advance the theory, design, and application of biologically and linguistically 
            ...
            <Card className="glass border-accent/20 glow-purple hover-glow transition-all duration-500 animate-slide-in-right">
              <CardHeader>
                <CardTitle className="flex items-center gap-4 text-2xl">
                  ...
                  <span className="text-glow-cream">Our Vision</span>
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-lg text-muted-foreground leading-relaxed">
                  To be the leading global community for computational intelligence, fostering innovation 
                  through research, education, and collaboration that addresses real-world challenges 
                  and creates a positive impact on society.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-24 glass-intense px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-glow-cream">Our Impact</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Making a difference both globally and locally through research, education, and innovation
            </p>
          </div>
            ...
            <Card className="glass border-accent/20 glow-purple hover-glow transition-all duration-500 animate-slide-in-left">
              <CardHeader>
                <CardTitle className="flex items-center gap-4 text-2xl">
                  ...
                  <span className="text-glow-cream">Global Impact</span>
                </CardTitle>
              </CardHeader>
            ...
            <Card className="glass border-accent/20 glow-purple hover-glow transition-all duration-500 animate-slide-in-right">
              <CardHeader>
                <CardTitle className="flex items-center gap-4 text-2xl">
                  ...
                  <span className="text-glow-cream">Local Impact</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                {[
              ...
              >
                <CardContent className="p-8">
                  <div className="w-20 h-20 gradient-purple-glow rounded-full flex items-center justify-center mx-auto mb-6 glow-purple animate-float">
                    <div className="text-accent">{activity.icon}</div>
                  </div>
                  <h3 className="font-semibold mb-4 text-lg text-glow-cream">{activity.title}</h3>
              ...
              >
                <CardContent className="p-8">
                  <div className="relative mb-6">
                    ...
                    <Badge 
                      variant="secondary" 
                      className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 bg-accent/20 text-accent border-accent/30 glow-purple"
                    >
                      {member.role}
                    </Badge>
                  </div>
                  
                  <h3 className="font-semibold mb-2 text-lg text-glow-cream">{member.name}</h3>
                  <p className="text-muted-foreground mb-6">{member.email}</p>
                  
                  <div className="flex justify-center space-x-4">
                    <a 
                      href={member.linkedin} 
                      className="text-muted-foreground hover:text-accent transition-all duration-300 hover-glow p-2 rounded-full glass"
                    >
